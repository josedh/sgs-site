    ...
    var defaults = {
                ...
                return this.each(function() {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if (
                            ...
                            $this.attr('type').toLowerCase() === 'phone'
                        ) {
                            message =
                                settings.builtInValidators.validphone.message
                            //message = 'Not a valid phone number <!-- data-validator-phoneagain-message to override -->'
        ...
        builtInValidators: {
            ...
            validphone: {
                ...
                message:
                    'Not a valid phone number <!-- data-validator-phoneagain-message to override -->'
            },
            number: {
                name: 'Number',
                type: 'regex',
